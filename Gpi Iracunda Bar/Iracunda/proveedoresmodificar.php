					...
					<div class="mdl-cell mdl-cell--12-col">
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="mdl-cell mdl-cell--12-col">
											...
											<select class="mdl-textfield__input" type="text" name="txtidp" id="txtidp">
													<option value="" disabled="" selected="">Seleccione el proveedor</option>
													<?php foreach($total as $proveedor) { ?>
													<option value="<?php echo $proveedor['idp'] ?>"><?php echo $proveedor['nombre'] ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
								...
								Modificar Proveedor
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" text" name="txtcorreo" id="txtcorreo">
												<label class="mdl-textfield__label" for="StrockProduct">Nuevo Correo</label>
											</div>
										</div>
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" name="txttelefono" id="txttelefono">
												<label class="mdl-textfield__label" for="StrockProduct">Nuevo Numero de telefono</label>
											</div>
										</div>
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
											<div class="mdl-textfield mdl-js-textfield">
										...
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" name="txtnota" id="txtnota">
