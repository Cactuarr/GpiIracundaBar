							...
							<div class="full-width panel-tittle bg-primary text-center tittles">
								Producto a modificar
										...
										<div class="mdl-cell mdl-cell--12-col">
											...
											<select class="mdl-textfield__input" type="text" name="txtcodigo" id="txtcodigo">
													<option value="" disabled="" selected="">Seleccione el Producto</option>
													<?php foreach($total as $inventario) { ?>
													<option value="<?php echo $inventario['codigo'] ?>"><?php echo $inventario['nombre'] ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
								...
								Modificar Producto
										...
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" text" name="txtstock" id="txtstock">
												<label class="mdl-textfield__label" for="StrockProduct">Nueva Cantidad del Producto</label>
											</div>
										</div>
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" name="txtProveedoractual" id="txtProveedoractual">
												<label class="mdl-textfield__label" for="StrockProduct">Nuevo Proveedor del Producto</label>
											</div>
										</div>
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" name="txtPrecio" id="txtPrecio">
												<label class="mdl-textfield__label" for="StrockProduct">Nuevo Precio por Unidad</label>
											</div>
										</div>
										<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" name="txtnotificacion" id="txtnotificacion">
												<label class="mdl-textfield__label" for="StrockProduct">Nueva cantidad minima para mostrar notificacion</label>
											</div>
										</div>
